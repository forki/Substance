...
{
    internal class StructuralArray<T> : IStructuralComparable, IStructuralEquatable
    {
        private readonly T[] array;

        public StructuralArray(T[] xs)
        {
            array = xs;
        }
        ...
        {
            return comparer.Compare(array, other);
        }

        public bool Equals(object other, IEqualityComparer comparer)
        {
            return comparer.Equals(array,other);
        }

        public int GetHashCode(IEqualityComparer comparer)
        {
            return comparer.GetHashCode(array);
        }
    }
    ...
    public partial struct ImmutableArray<T> : IReadOnlyList<T>, IList<T>, IEquatable<ImmutableArray<T>>, IImmutableList<T>, IList, IImmutableArray, IStructuralComparable, IStructuralEquatable
    {
        ...
        bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer)
        {
            ...
            //TODO: Do Structural comparison
            return comparer.Equals(self.array, otherArray);
        }
        ...
        int IStructuralEquatable.GetHashCode(IEqualityComparer comparer)
        {
            var self = this;
            //TODO: Do Structural comparison
            return self.array != null ? comparer.GetHashCode(self.array) : self.GetHashCode();
        }
        ...
        int IStructuralComparable.CompareTo(object other, IComparer comparer)
        {
            ...
            {
                //TODO: Do Structural comparison
                return comparer.Compare(self.array, otherArray);
            }
        ...
        private ImmutableArray<T> RemoveAtRange(ICollection<int> indexesToRemove)
        {
            ...
            foreach (var indexToRemove in indexesToRemove)
            {
                ...
                Debug_.Assert(indexToRemove > lastIndexRemoved); // We require that the input be a sorted set.
